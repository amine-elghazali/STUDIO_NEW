                ...
                <div class="col-12">
                    <div class="main__carousel-wrap">
                        <div class="main__carousel main__carousel--events owl-carousel" id="events">
                            <div class="event" data-bg="<?php echo e(asset ('img/admin/singer.jpg')); ?>">
                                <h3 class="event__title"><a href="Artists">Artists</a></h3>
                                
                            </div>

                            <div class="event" data-bg="<?php echo e(asset ('img/admin/albums.jpg')); ?>">
                                <h3 class="event__title"><a href="Albums">Albums</a></h3>

                            </div>

                            <div class="event" data-bg="<?php echo e(asset ('img/admin/songs.jpg')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\proj\STUDIO_NEW\resources\views/dashboard/admin/index.blade.php ENDPATH**/ ?>